...
- [기여와 근거](00-source-and-ownership.md): 프로젝트 기간 직접 구현, 팀 범위, 종료 후 실험 구분
- [커밋으로 복원한 판단 변화](14-development-timeline.md): 실패·리뷰·수정과 검증 근거
- [팀 아키텍처 비용 회고](13-architecture-cost-postmortem.md): Git 토폴로지와 AWS 원장을 대조한 종료 후 분석
...
- [이력서 초안](../resume.md)
- [Data Foundation 역량 대조](12-data-foundation-fit.md): 공개 성과표가 아니라 제출 전 공백을 확인하는 내부 점검표
