...
- 카탈로그 계층 테스트 90종 (MCP 신뢰 경계 18 · 프로토콜 8 · 조회 API 9 · 결과 적재 키 9 · 문서·코드 대조 17 · 그 외 27)
...
make catalog-test      # 카탈로그 테스트   → 90 passed
...
- 실제로 반복 사용한 사용자가 없습니다. 시연에 성공한 것과 쓰인 것은 다릅니다. 다만 7월 AWS 청구서에 로그 수집 64.35GB, LoadBalancer 2,150시간, 공인 IPv4 8,179시간이 남아 있어 한 달 가까이 가동된 것은 확인됩니다 — [청구서](docs/evidence/aws-bill-2026-07/README.md)
